...
public class LuloBearerTokenRequestPostProcessor implements RequestPostProcessor {
    ...
    public MockHttpServletRequest postProcessRequest(MockHttpServletRequest request) {
        try {
            ...
            Date now = new Date();
            JWTClaimsSet jwtClaims = new JWTClaimsSet.Builder().issuer("https://lulobank.com.co").subject(ID_CLIENT)
